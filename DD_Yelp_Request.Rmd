...
write_csv(restaurants_df, "./nyc_Dunkin.csv", na = "NA")
```
...
restaurants_df_backup <- restaurants_df
write_csv(restaurants_df, "./manhattan_Dunkin.csv", na = "NA")
```
...
restaurants_df_backup <- restaurants_df
write_csv(restaurants_df, "./Brooklyn_Dunkin.csv", na = "NA")
```
...
restaurants_df_backup <- restaurants_df
write_csv(restaurants_df, "./Queens_Dunkin.csv", na = "NA")
```
...
restaurants_df_backup <- restaurants_df
write_csv(restaurants_df, "./Bronx_Dunkin.csv", na = "NA")
```
...
restaurants_df_backup <- restaurants_df
write_csv(restaurants_df, "./StatenIsland_Dunkin.csv", na = "NA")
```
